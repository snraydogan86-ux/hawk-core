...
KILL_SCOPES = ("global", "chat", "hawkbase", "model_gateway", "multi_agent", "research",
               "sandbox", "pc_worker", "web", "web_research", "gpu_cloud", "training",
...
def set_kill(on: bool, reason: str = "", actor: str = "admin", scope: str = "global") -> Dict[str, Any]:
    """Kill aç/kapat. scope='global' → tüm sistem; scope=chat|multi_agent|research|pc_worker|web|gpu_cloud|training
