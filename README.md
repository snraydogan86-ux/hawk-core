...
| Voice — speech + real-time conversation | ✅ |
...
| Tool-calling — the model calls real tools | ✅ |
...
| **Benchmark** | 64/73 and improving — see [RESULTS](eval/RESULTS.md) | Full details: [`MODEL_CARD.md`](MODEL_CARD.md). Training pipeline: [`training/`](training/).
...
| **Self-Healing** | Watches its own health, recovers automatically. | Deep dive: [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md).
...
- [Model Card](MODEL_CARD.md) · [Benchmark Results](eval/RESULTS.md) · [Changelog](CHANGELOG.md) · [Roadmap](ROADMAP.md)
